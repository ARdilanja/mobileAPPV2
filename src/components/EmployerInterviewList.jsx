...
const EmployerInterviewList = () => {
  const data = [
    { id: "1", logo: require("../assets/images/infosys.png"), company: "Infosys", role: "React Native Developer" },
    { id: "2", logo: require("../assets/images/accenture.png"), company: "Accenture", role: "UX Designer" },
